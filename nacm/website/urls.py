...
urlpatterns = [
    ...
    path('config/routing_static_ipv6', views.config_static_ipv6.as_view(), name="config/routing_static_ipv6"),
    path('config/routing_dynamic', views.config_dynamic.as_view(), name="config/routing_dynamic"),
    path('config/routing_dynamic_ipv6', views.config_dynamic_ipv6.as_view(), name="config/routing_dynamic_ipv6"),
