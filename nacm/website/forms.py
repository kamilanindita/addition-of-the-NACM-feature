...
class SettingForm(ModelForm):
	class Meta:
		...
		fields = [
			...
			'sett_name_desc',
			'sett_static_routing',
			'sett_static_routing_ipv6',
			'sett_dynamic_routing_ospf',
   			'sett_dynamic_routing_ospf_ipv6',
		...
		widgets = {
			'sett_static_routing': forms.Textarea(attrs={'cols':100, 'rows':4}),
   			'sett_static_routing_ipv6': forms.Textarea(attrs={'cols':100, 'rows':4}),
			'sett_dynamic_routing_ospf': forms.Textarea(attrs={'cols':100, 'rows':4}),
   			'sett_dynamic_routing_ospf_ipv6': forms.Textarea(attrs={'cols':100, 'rows':4}),
